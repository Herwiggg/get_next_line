...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/01 15:13:16 by almichel          #+#    #+#             */
/*   Updated: 2023/12/01 15:17:14 by almichel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_check_n(char *str, int *error)
{
	...
	{
		dest = malloc((ft_strlen(str, 0) + 1) * sizeof(char));
		if (!dest)
		{
			*error = 1;
			return (NULL);
	...
	{
		dest = malloc((ft_strlen(str, 1) + 2) * sizeof(char));
		if (!dest)
		{
			*error = 1;
			return (NULL);
